...
export async function ensureSchema(pool) {
  ...
  `)
  await pool.query(`create index if not exists ti_ea_documents_session_code_idx on ti_ea_documents(session_code);`)
  await pool.query(`create index if not exists ti_ea_documents_session_code_archived_at_idx on ti_ea_documents(session_code, archived_at);`)
  await pool.query(`create index if not exists ti_ea_documents_session_code_uploaded_at_idx on ti_ea_documents(session_code, uploaded_at desc);`)
  ...
  `)
  await pool.query(`create index if not exists ti_ea_activity_timeline_session_code_idx on ti_ea_activity_timeline(session_code);`)
  await pool.query(`create index if not exists ti_ea_activity_timeline_session_code_archived_at_idx on ti_ea_activity_timeline(session_code, archived_at);`)
  await pool.query(`create index if not exists ti_ea_activity_timeline_session_code_created_at_idx on ti_ea_activity_timeline(session_code, created_at desc);`)
  ...
  `)
  await pool.query(`create index if not exists ti_ea_case_state_updated_at_idx on ti_ea_case_state(updated_at desc);`)
